...
def extract_edge_features(df, addr_to_index, center_address=None):
    ...
    features = edges_df[['value', 'gasUsed', 'gasPrice', 'timeStamp', 'tx_type']].copy()
...
def build_two_layer_multigraph(address, max_neighbors=10, center_address=None, max_txs=10):
...
if __name__ == '__main__':
    ...
    main_graph, main_addr_to_index, neighbor_graphs = build_two_layer_multigraph('0x8f13a1d43408b6434dd10e161361386f3952d665', max_neighbors=10, max_txs=10)
